...
"Fertig" bedeutet je nach Typ etwas anderes:
...
- analysis: Zahlen nachvollziehbar, Methodik dokumentiert, Schlussfolgerungen belegt
- concept: Logik konsistent, Stakeholder-Perspektiven berücksichtigt
- education: Lernziel erreichbar, Verständlichkeit geprüft
- automation: Workflow getestet, Edge-Cases abgedeckt, Logs sauber
- legal: Quellen zitiert, Aussagen rechtlich geprüft, Formulierungen klar
- finance: Zahlen geprüft, Annahmen dokumentiert, Modell konsistent
- (vollständige Liste und Detailkriterien in `references/project-profiles.md`)
...
**Recap-Sprache nach Projekttyp anpassen:** Ein Coding-Recap klingt anders als ein Content-Recap. Passe Formulierung und Fokus an den aktiven Projekttyp an:
- coding: "Die Funktion X macht Y. Sie nimmt Z entgegen und gibt W zurück."
- content: "Das Kapitel behandelt X. Es baut auf Y auf und führt den Leser zu Z."
- design: "Der Screen zeigt X. Der User kann Y tun und landet dann bei Z."
- research: "Die Recherche hat X herausgefunden. Das widerlegt/bestätigt Annahme Y."
- analysis: "Die Analyse zeigt: X. Das bedeutet für das Projekt: Y."
- (Ton und Struktur für alle weiteren Typen aus `references/project-profiles.md`)
